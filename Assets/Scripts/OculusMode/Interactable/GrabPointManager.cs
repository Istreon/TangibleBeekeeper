...
public class GrabPointManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        firstSpring.spring = gameObject.transform.parent.gameObject.GetComponent<Rigidbody>().mass;*/
        secondJoint.connectedBody = secondDefault.GetComponent<Rigidbody>();
        /*JointSpring secondSpring = secondJoint.spring;
        secondSpring.spring = gameObject.transform.parent.gameObject.GetComponent<Rigidbody>().mass;*/
